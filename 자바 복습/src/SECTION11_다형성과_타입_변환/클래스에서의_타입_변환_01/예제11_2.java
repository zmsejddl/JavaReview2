...
public class 예제11_2 {
	public static void main(String[] args) {
		Car c1 = new SchoolBus(); // 1차 상속 관계가 아니더라고
									// 자동 타입 변환 가능
	...
	/*
	 * 해설
	 * 27: OpenCar 클래스는 Car 클래스와 2차 상속 관계를 가지고 있기 때문에 자동 타입 변환이 가능합니다.
	 * 29~30: OpenCar 클래스와 SportsCar 클래스는 Bus 클래스와 같은 상위 계층의 클래스 Car와 상속 관계는 맞지만,
