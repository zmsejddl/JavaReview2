...
public class 예제6_16 {
	public static void main(String[] args) {
		...
		int[][] lotto = { { 2, 6, 11, 33, 42, 44 }, { 1, 6, 17, 22, 24, 33 }, { 7, 16, 24, 33, 42, 44 },
				{ 11, 27, 32, 34, 43, 46 }, { 6, 17, 22, 24, 33, 41 } };
		...
		/*
		 * 해설
		 * 30: 문자열은 객체형 데이터 타입이기 때문에 값을 비교할 때 ==(부등호) 비교가 아닌 equals(비교 대상) 함수를 사용해 비교합니다. (같으면 true, 다르면 false)
		 * 41: Scanner는 프로그램 종료 시 닫아주는 것이 좋습니다.
		 */
	}
}
